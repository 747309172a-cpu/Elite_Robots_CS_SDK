...
public sealed class ElitePrimaryClient : IDisposable
{
    ...
    private static void OnNativeRobotException(ref NativeMethods.ElitePrimaryRobotExceptionNative ex, nint userData)
    {
        ...
        if (gch.Target is not ElitePrimaryClient client || client._managedRobotExceptionCallback is null)
        {
            return;
        }
